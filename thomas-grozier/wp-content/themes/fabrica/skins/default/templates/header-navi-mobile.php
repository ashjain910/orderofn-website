...
<div class="menu_mobile menu_mobile_<?php echo esc_attr( fabrica_get_theme_option( 'menu_mobile_fullscreen' ) > 0 ? 'fullscreen' : 'narrow' ); ?> scheme_dark">
	<div class="menu_mobile_inner<?php echo esc_attr( $fabrica_show_widgets == 1  ? ' with_widgets' : '' ); ?>">
        ...
        <div class="menu_mobile_content_wrap content_wrap">
            ...
            if ( ! empty( $fabrica_menu_mobile ) ) {
                ...
                if ( strpos( $fabrica_menu_mobile, '<nav ' ) === false ) {
