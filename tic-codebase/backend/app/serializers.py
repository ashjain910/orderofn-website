...
class AdminJobCreateUpdateSerializer(serializers.ModelSerializer):
    ...
    def to_internal_value(self, data):
        """Override to handle JSON string fields from multipart form data"""
        import json
            ...
            if field in data:
                ...
                if isinstance(value, str) and value.strip():
                    try:
                        ...
                        # Let the field validator handle the error
                        pass
                elif not value:
                    data[field] = []
    ...
    def validate_subjects(self, value):
        ...
        if isinstance(value, str):
            ...
            try:
                ...
                raise serializers.ValidationError(f"Invalid JSON format for subjects: {str(e)}")
    ...
    def validate_benefits(self, value):
        ...
        if isinstance(value, str):
            ...
            try:
                ...
                raise serializers.ValidationError(f"Invalid JSON format for benefits: {str(e)}")
