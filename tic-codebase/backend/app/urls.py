...
urlpatterns = [
    ...
    path('password-reset/validate-token', views.password_reset_validate_token, name='password-reset-validate-token'),
    ...
    path('admin/jobs/<int:job_id>/email-logs', views.admin_job_email_logs, name='admin-job-email-logs'),
]
